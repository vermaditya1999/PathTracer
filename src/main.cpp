...
//
//    Sphere *sphere1 = new Sphere(new Diffused(Color(0.8, 0.4, 0.6), Color(1.0), 0.8, 0.1),
//                                 125, vec3(-170, -250, -2300));
//    scene.addObject(sphere1);
//
...
//
//    Sphere *sphere2 = new Sphere(new Glossy(Color(0.2, 0.6, 0.8), Color(), 0.4, 0.4, 0.1, 16),
//                                 125, vec3(170, -275, -1950));
//    scene.addObject(sphere2);
//
//    Sphere *sphere3 = new Sphere(new Dielectric(Color(1.0, 1.0, 1.0), Color(), 1.7),
//                                 125, vec3(0, -275, -1600));
...
//    scene.addLight(light1);
    ...
    Sphere *sphere4 = new Sphere(new Diffused(Color(0.1), Color(0), 1.0, 0),
                                 100, vec3(0, -300, -1600));
